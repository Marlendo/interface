...
export class RegisterPage {
  ...
  doRegister(){
    ...
    if (!this.registerForm.valid){
      ...
      this.authService.register(this.registerForm.value.nama,this.registerForm.value.alamat,this.registerForm.value.email, this.registerForm.value.password).then( authService => {
